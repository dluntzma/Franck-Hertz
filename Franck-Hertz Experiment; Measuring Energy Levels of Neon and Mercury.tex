...
\caption{The difference in voltage for consecutive minimum in the lock-in output. The higher minima of the 185$^{\circ}$C data were lost due to ionization. The error for these values is 5$\%$. These values are plotted in Figure~\ref{lockin-minima}}
...
\caption{The difference in voltage for consecutive positive slope x-intercepts from the lock-in output. The first dip was indiscernible for the 215$^{\circ}$C data and the higher minima of the 195$^{\circ}$C and 185$^{\circ}$C data were lost due to ionization. The error for these values is 1.3$\%$ and they are plotted in Figure~\ref{lockin_intercepts}}
...
\caption{The plot of the difference in voltage between minima versus the number of the minimum. All values have an uncertainty of $\%$. The lines are linear fits to the data for each temperature. }
...
\caption{The plot of the difference in voltage between positive-slope x intercepts versus the number of the minimum. All values have an uncertainty of ~1.3$\%$. The lines are linear fits to the data for each temperature. The two fits with steeper slopes correspond to the 195$^{\circ}$C and 185$^{\circ}$C data sets which were truncated due to ionization.}
